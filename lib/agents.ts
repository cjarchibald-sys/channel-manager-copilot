...
export const agents: Agent[] = [
  {
    ...
    example: {
      ...
      asksFromPartner: "Co-funded SE resource for Clarix CX evaluations (at least 2 days/week). Executive sponsor introduction at Westlake Insurance Group. Competitive battlecard against RingCentral. $25K MDF approval for Q3 partner-led demand gen event in Chicago.",
      internalAsks: "Clarix CX SE coverage from the overlay team for Presidio's active pipeline. Exec introduction at Westlake Insurance — VP or above. Marketing approval for $25K MDF co-fund. RingCentral competitive displacement support from Product Marketing.",
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "topic", label: "Topic", type: "text", placeholder: "e.g. Selling Clarix into Healthcare, displacing Avaya on-prem", required: true },
