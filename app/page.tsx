      ...
      <div style={{ background: "#0F172A", borderTop: "3px solid #6366F1" }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: "#A5B4FC" }}>This is v1. What comes next.</p>
              ...
              <p className="text-sm leading-relaxed mt-4 border-t pt-4" style={{ color: "rgba(255,255,255,0.82)", borderColor: "rgba(255,255,255,0.18)" }}>
